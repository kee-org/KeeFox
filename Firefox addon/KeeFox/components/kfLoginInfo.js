...
//    
//   
//	for (var j = 0; j < entry.formFieldList.size(); j++) 
//	{
//		var kpff = entry.formFieldList[j];
//  
//		if (kpff.type == formFieldType.password)
//		{
...
//			this.passwords[] = newField;

//		} else if (kpff.type == formFieldType.text || kpff.type == formFieldType.username
//			 || kpff.type == formFieldType.select || kpff.type == formFieldType.radio
//			  || kpff.type == formFieldType.checkbox)
//		{
...
//			switch (kpff.type)
//			{
//				case formFieldType.username: usernameIndex = otherLength; type = "username"; break;
//				case formFieldType.text: type = "text"; break;
//				case formFieldType.radio: type = "radio"; break;
//				case formFieldType.checkbox: type = "checkbox"; break;
//				case formFieldType.select: type = "select-one"; break;
//			}
...
//        this.init(entry.URLs,
//         entry.formActionURL,
//          entry.HTTPRealm,
//                     *aUsernameIndex,
//                           *aPasswords,
//                     entry.uniqueID, entry.title, *otherFieldsArray, maximumPage);
//                     
...
//formFieldType.password = 1;
//formFieldType.username = 0;
//formFieldType.radio = 4;


//kpff.type == formFieldType.text || kpff.type == formFieldType.username
//			 || kpff.type == formFieldType.select || kpff.type == formFieldType.radio
//			  || kpff.type == formFieldType.checkbox)